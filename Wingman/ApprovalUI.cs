...
public class ApprovalUI(ChatPanel chatPanel) : IApprovalUI
{
    public Task<bool> RequestApprovalAsync(string command, string purpose, string reason)
    {
        var tcs = new TaskCompletionSource<bool>(TaskCreationOptions.RunContinuationsAsynchronously);

        chatPanel.Dispatcher.InvokeAsync(() =>
        {
